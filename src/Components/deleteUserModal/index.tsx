...
export default function DeleteUserModal({ user, setUsers }: Props): React.ReactElement {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Button color="error" type="submit" variant="outlined" size="medium" onClick={() => deleteUser(user)}>
            Deletar Usuario
          </Button>
          <Button type="submit" variant="outlined" size="medium" onClick={handleClose}>
            Cancelar
          </Button>
        </Box>
      </Modal>
